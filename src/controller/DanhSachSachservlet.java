...
/**
 * Servlet implementation class DanhSachSachservlet
 */
...
public class DanhSachSachservlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		list=new SachBO().getList();
		request.setAttribute("listsach", list);
		RequestDispatcher rd = request.getRequestDispatcher("resources/admin/Sach/danhsachsach.jsp");
