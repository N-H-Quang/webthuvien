	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getParameter("id") == null) {
			...
			if ("send".equals(request.getParameter("send"))) {
				...
				RequestDispatcher rd = request.getRequestDispatcher("resources/admin/Sach/suasach.jsp");
...
//	            String basePath = "C:/Users/nguyen quang/eclipse-workspace/Mockjsp/WebContent/resources" + File.separator + UPLOAD_DIR + File.separator;
			String basePath = "C:/Users/nguyen quang/eclipse-workspace/webthuvien/WebContent/resources/" + UPLOAD_DIR
					+ File.separator;
