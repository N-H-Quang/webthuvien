			...
			<div class="col-sm-11 col-md-offset-1">
				<form action="ThemTheLoai" method="post">
					<p>
						...
						<input class="w3-input" type="text" name="matl">
					</p>
					<p>
					...
					<p>
						...
						<input class="w3-input" type="text" name="tentl">
					</p>
					<div style="text-align: center;">
					   <button class="btn btn-primary" type="submit" value="submit" name="submit">Thêm Thể Loại</button>
